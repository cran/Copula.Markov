...
function(Y,size,k=3,plot=TRUE){
  ...
  list(p=result_p,alpha=result_a,CL=result,
         out_of_control=out_control,
         Gradient=Score,Hessian=Hessian,
         Mineigenvalue_Hessian=min(eigen(Hessian)$value))
